...
\begin{figure}[H]
  ...
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[height=.5\textwidth, keepaspectratio]{graphs/plots/beta_mrr_fb.png}
    \caption{FB15K-237}
    \label{fig5:betamrrfb}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[height=.5\textwidth]{graphs/plots/beta_mrr_wn.png}
    \caption{WN18RR}
